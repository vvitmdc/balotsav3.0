...
public class GlideRequests extends RequestManager {
  ...
  @Override
  public GlideRequest<Drawable> load(Object model) {
  ...
  @Override
  public GlideRequest<File> download(Object model) {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof app.balotsav.com.vvitbalotsav.utils.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new app.balotsav.com.vvitbalotsav.utils.GlideOptions().apply(toSet));
    }
  }
}
